...
<div class="page-content">
    <form class="form-inline" action="saveRoleAndPermissions" method="post" name="form1">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">权限分配列表&nbsp;&nbsp;&nbsp;
            		...
            		<button type="button" class="btn btn-primary" onclick="form1.action='deleteRoleAndPermissions';form1.submit();"   >删除权限</button></div>
            		</div>
	...
	$(function(){
        ...
        if (message=='角色不能为空') {
        	 alert('添加失败,角色不能为空!');
		} else if(message=='已经拥有该角色'){
			alert('添加失败,已经拥有该角色!');
		} else if(message== '权限不能为空'){
			alert('添加失败,权限不能为空!')
		}else if(message=='删除权限不能为空'){
			alert('请选择要删除的权限,权限不能为空!')
		}else if(message=='添加角色成功'){
			alert('添加角色成功!')
		}
